...
Adds tooltips to the Blizzard Macro UI. When you move the mouse cursor
over the icon for one of your macros, a tooltip will show the name and
contents of the macro. That is all.


Download
-----------

* [WoWInterface](http://www.wowinterface.com/downloads/info22720-MacroTooltip.html)
* [Curse](http://www.curse.com/addons/wow/macrotooltip)
...
Does not require any translations.
